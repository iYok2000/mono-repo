...
export default function EditDevToolkitPage() {
    ...
    const loadToolkit = async () => {
      ...
      try {
        ...
        setModal({
          ...
          message: "ไม่สามารถโหลดข้อมูล Toolkit ได้",
        });
      } finally {
        setLoading(false);
      }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await toolkitService.updateToolkit(id, {
      ...
      setModal({
        ...
        type: "success",
        title: "สำเร็จ",
        message: "แก้ไข Toolkit สำเร็จแล้ว",
      });
      ...
      setModal({
        ...
        type: "error",
        title: "เกิดข้อผิดพลาด",
        message: error?.response?.data?.message || "ไม่สามารถแก้ไข Toolkit ได้",
      });
    } finally {
      setSubmitting(false);
    }
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-8 pb-12">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground">แก้ไข DevToolkit</h1>
