...
import { ContentSection } from "@/components/devtoolkit/ContentSection";
import { DesktopTOC, MobileTOC, type TOCItem } from "@/components/devtoolkit/TableOfContents";
import * as toolkitService from "@/services/toolkitService";
import type { DevToolkitDetail } from "@/types/devtoolkit";

export default function ToolkitDetailPage() {
  const params = useParams();
  const id = params.id as string;

  const [toolkit, setToolkit] = useState<DevToolkitDetail | null>(null);
              ...
              <div className="p-4 sm:p-5 lg:p-6 max-w-none prose prose-sm">
                ...
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html: renderMarkdown(toolkit.description),
                  }}
                />
