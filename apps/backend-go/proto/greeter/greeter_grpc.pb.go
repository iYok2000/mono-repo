...
const (
	...
	GreeterService_SayHelloStream_FullMethodName = "/greeter.GreeterService/SayHelloStream"
)
...
func (c *greeterServiceClient) SayHelloStream(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[HelloResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type GreeterService_SayHelloStreamClient = grpc.ServerStreamingClient[HelloResponse]
...
func (UnimplementedGreeterServiceServer) SayHelloStream(*HelloRequest, grpc.ServerStreamingServer[HelloResponse]) error {
...
func _GreeterService_SayHelloStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(GreeterServiceServer).SayHelloStream(m, &grpc.GenericServerStream[HelloRequest, HelloResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreeterService_SayHelloStreamServer = grpc.ServerStreamingServer[HelloResponse]
